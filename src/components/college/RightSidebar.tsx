    ...
    <aside className="hidden lg:flex flex-col gap-lg w-[320px] sticky top-24">
      ...
      <div className="bg-surface rounded-xl border border-outline-variant p-md flex flex-col gap-md">
        ...
        <div className="flex flex-col gap-sm">
          <div className="flex items-center justify-between p-sm rounded-lg hover:bg-surface-container-high transition-colors cursor-pointer border border-transparent hover:border-outline-variant group">
        ...
        <button className="w-full py-sm text-primary font-label-md text-label-md hover:bg-surface-container-high rounded-lg transition-colors border border-outline-variant">
          View All Clubs
        </button>
      </div>
      ...
      <div className="bg-surface rounded-xl border border-outline-variant p-md flex flex-col gap-md">
        ...
        <div className="flex flex-col gap-sm">
          <div className="flex flex-col gap-base cursor-pointer group">

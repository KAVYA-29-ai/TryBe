...
export default function Signup() {
  ...
  return (
    <div className="bg-background text-on-background font-body-md min-h-screen flex items-center justify-center relative overflow-hidden">
      {/* Atmospheric Background (Vaporwave-Lite / Kinetic Connection) */}
      <div 
          ...
          <form onSubmit={handleSignup} className="flex flex-col gap-md">
            ...
            <div>
              ...
              <div className="relative">
                <input className="w-full h-12 bg-surface-container-low border border-outline-variant rounded-lg px-md font-body-md text-body-md text-on-surface focus:outline-none focus:border-primary-container focus:ring-1 focus:ring-primary-container transition-all placeholder:text-on-surface-variant/50" id="name" name="name" placeholder="Alex Morgan" required type="text" />
              </div>
            </div>

            {/* Email / College ID Field */}
            <div>
              <label className="block font-label-sm text-label-sm text-on-surface mb-xs" htmlFor="email">Email or College ID</label>
              <div className="relative">
                <input className="w-full h-12 bg-surface-container-low border border-outline-variant rounded-lg px-md font-body-md text-body-md text-on-surface focus:outline-none focus:border-primary-container focus:ring-1 focus:ring-primary-container transition-all placeholder:text-on-surface-variant/50" id="email" name="email" placeholder="name@university.edu" required type="email" />
              </div>
            </div>
            ...
            <div>
              ...
              <div className="relative">
                <input className="w-full h-12 bg-surface-container-low border border-outline-variant rounded-lg pl-md pr-12 font-body-md text-body-md text-on-surface focus:outline-none focus:border-primary-container focus:ring-1 focus:ring-primary-container transition-all placeholder:text-on-surface-variant/50" id="password" name="password" placeholder="••••••••" required type={showPassword ? "text" : "password"} />
                <button 
            ...
            <motion.button 
              ...
              className="w-full h-12 mt-xs bg-secondary-container hover:bg-[#9b3141] text-on-secondary-container font-label-md text-label-md rounded-lg transition-colors flex items-center justify-center gap-2 relative group overflow-hidden border border-transparent hover:border-on-secondary-container/20" 
              type="submit"
            >
            ...
            <motion.button 
              whileTap={{ scale: 0.97 }}
              transition={{ type: 'spring', bounce: 0, duration: 0.3 }}
              className="w-full h-12 bg-surface-container-low border border-outline-variant hover:bg-surface-container hover:border-outline rounded-lg flex items-center justify-center gap-sm transition-colors text-on-surface font-label-md text-label-md group" 
              type="button" 
